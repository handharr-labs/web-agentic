...
Create a Repository protocol following `.claude/reference/contract/domain.md §3.2`.

## Steps

1. **Grep** `.claude/reference/contract/domain.md` for `§3.2`; only **Read** the full file if the section cannot be located
