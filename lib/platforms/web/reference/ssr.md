...
## Next.js Rendering Rules (Quick Recap) <!-- 15 -->
...
## Data Layer — Isomorphic Code, Split Instantiation <!-- 25 -->
...
## Presentation Layer — Mostly Client <!-- 20 -->
...
## Complete Rendering Map (Quick Reference) <!-- 55 -->
