...
Configure a freshly wired iOS project for software-dev-agentic. Called by `setup-worker`.
...
```bash
cp .claude/software-dev-agentic/platforms/ios/CLAUDE-template.md CLAUDE.md
```
